...
export abstract class Actor {
    ...
    constructor(_health: number, _maxHealth: number, _inventory: Item[], _position: Room) {
        this.health = _health;
    ...
    takeDamage(_damageValue: number): void {
